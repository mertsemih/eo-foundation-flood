...
## 2026-09-13, local queue q9 done: 76 runs
- Did: frozen seeds 1-2 at 2 % / 1 %, full seeds 1-2 at 100 %, LoRA r=16 and wide-target ablation, UNet-decoder seeds 1-2 at 100 % and 5 %. Only the 8 `prithvi_lora` seed-1/2 runs at 100/25/10/5 % remain (Colab, after fixing its environment: restart after pip, pin peft==0.20.0, uninstall the stale torchao).
- Full-label table with 3 seeds (test / Bolivia): U-Net scratch 0.823±0.008 / 0.766±0.021; U-Net ImageNet 0.829±0.015 / 0.781±0.007; Prithvi frozen 0.701±0.005 / 0.606±0.083; Prithvi LoRA 0.778 / 0.725 (1 seed so far); LoRA + UNet decoder 0.776±0.014 / 0.730±0.038; Prithvi full 0.770±0.010 / 0.695±0.050.
- **Decoder ablation with seeds:** the UNet-style decoder's seed-0 advantage (0.790) vanished; over 3 seeds it is 0.776 ± 0.014 at 100 % and 0.760 ± 0.022 at 5 %, i.e. equal to the FCN head in-distribution and ~4 points better at 5 %. A better head does not close the gap to the U-Nets (0.81-0.83). Keep the FCN head as the main configuration; report the decoder as an ablation showing the encoder, not the head, is the limit.
